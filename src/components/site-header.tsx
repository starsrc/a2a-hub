                ...
                <div className="flex h-14 items-center justify-between">
                    <div className="flex items-center gap-4">
                        <Link href="/" className="flex items-center gap-2 font-semibold">
                            <span
                                className="rounded bg-[color:var(--foreground)]/10 px-2 py-0.5 text-sm text-foreground">A2A</span>
                            <span>HUB</span>
                        </Link>
                        <nav className="hidden md:flex items-center">
                            <Link href="/"
                                  className="px-3 py-2 text-sm text-foreground/80 hover:text-foreground aria-[current=page]:text-foreground"
                                  aria-current="page">Discover</Link>
                            <Link href="/about"
                                  className="px-3 py-2 text-sm text-foreground/80 hover:text-foreground">About</Link>
                        </nav>
                    </div>
                ...
                <div className="md:hidden fixed inset-0 z-50">
                    ...
                    <div className="absolute inset-y-0 left-0 w-72 bg-background border-r p-4 flex flex-col gap-2">
                        ...
                        <Link href="/" onClick={() => setOpen(false)}
                              className="rounded px-2 py-2 text-sm hover:bg-foreground/5">Discover</Link>
                        <Link href="/about" onClick={() => setOpen(false)}
                              className="rounded px-2 py-2 text-sm hover:bg-foreground/5">About</Link>
                    </div>
                </div>
            ) : null}
        </header>
